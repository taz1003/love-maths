...
/**
 * Gets the operands (the numbers) and the opretaor (plus, minus etc.)
...
/**
 * Gets the current score form the DOM and increases it by 1.
 */
...
/**
 * Gets the current tally of incorrect answers form the DOM and increases it by 1.
 */
